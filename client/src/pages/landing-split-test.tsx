...
import { CheckCircle, Star, Globe, Search, Calendar, Sword, DollarSign, Link as LinkIcon, ArrowRight, TrendingUp, Clock, Shield, Zap, Target, PlayCircle } from "lucide-react";
import { Link } from "wouter";
import { Dialog, DialogContent, DialogTrigger } from "@/components/ui/dialog";
import autobidderLogo from "@assets/Autobidder Logo (1)_1753224528350.png";

export default function LandingSplitTest() {
  ...
  const benefits = [
    {
      ...
      description: "The company that responds first usually wins the job. Give instant answers to 'Can you do it?', 'How much?', and 'When?'"
    },
    {
      icon: Clock,
      title: "24/7 Sales Machine",
      description: "Your site delivers information, builds trust, and closes jobs even while you sleep—no call-backs, no waiting"
    },
    {
      icon: Target,
      title: "Stand Out From Competition",
      description: "While competitors have identical websites, you offer a real interactive experience customers prefer"
    }
  ];
  ...
  const features = [
    ...
    {
      icon: Search,
      title: "SEO That Outperforms Agencies",
      description: "Our Site Ranking Strategy targets high-intent searches like 'pressure washing prices near me'—the buyers ready to hire, not browsers."
    },
    {
      icon: Calendar,
      title: "Instant Booking & Real-Time Availability",
      description: "Sync with your existing CRM, let customers view availability and book instantly. Seamless from curiosity to confirmation."
    },
    {
      icon: Sword,
      title: "Stand Out in a Crowded Market",
      description: "Turn your site into an interactive experience. Most pressure washing websites look identical—give customers what they want: fast, easy, online."
    },
    {
      icon: DollarSign,
      title: "Full Control Over Your Pricing",
      description: "Build extremely detailed pricing models, adjust anytime, and reflect real-world changes in materials, travel, or service tiers."
    },
    {
      icon: LinkIcon,
      title: "Connects With Your CRM",
      description: "Integrates with nearly any system via Zapier. Every new lead triggers the right follow-up instantly—email, text, or automation."
    }
  ];
      ...
      <section className="relative py-20 md:py-32 text-white">
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="mb-8 inline-block">
            <div className="bg-gradient-to-r from-blue-400/20 to-purple-400/20 backdrop-blur-xl border border-white/20 rounded-full px-6 py-3">
              <span className="text-sm font-medium text-white/90">
                🚀 Trusted by 2,400+ Pressure Washing & Home Service Businesses
              </span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-4xl mx-auto leading-relaxed">
            Convert more of your website visitors into paying customers while moving your leads through your sales process faster.
          </p>

          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 max-w-3xl mx-auto mb-12">
            <p className="text-lg text-white/90 mb-6">
              <strong className="text-white">In today's market, you're not just competing with other businesses—you're competing for attention.</strong> The company that responds first usually wins the job. Autobidder makes sure that's you.
            </p>
            <div className="text-left space-y-3 text-white/80">
              <p className="text-base">When a homeowner searches for a pressure washing company, they only care about three things:</p>
              <div className="pl-6 space-y-2">
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                  <span>Can you do the service I need?</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                  <span>When can you do it?</span>
                </div>
              </div>
              <p className="text-base pt-4">
                <strong className="text-white">Autobidder gives your customers all three answers instantly</strong>, in just a few clicks—no waiting for call-backs, no generic forms, no friction.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                Why Choose Autobidder?
              </span>
            </h2>
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Capture more leads, respond faster, and close more jobs—automatically.
            </p>
          </div>
      ...
      <section id="features" className="relative py-20 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              From high-end websites to SEO that actually works, we've got everything you need to outperform the competition.
            </p>
          </div>
      ...
      <section id="testimonials" className="relative py-20 bg-gradient-to-b from-slate-900 to-slate-800">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              See how home service businesses are using Autobidder to grow their revenue and streamline operations.
            </p>
          </div>
            ...
            {pricingPlans.map((plan, index) => (
              <Card key={index} className={`p-8 ${plan.popular ? 'border-4 border-blue-500 relative' : 'border-2'} hover:shadow-xl transition-all duration-300`}>
                ...
                <CardContent className="p-0">
                  ...
                  <Link href="/onboarding">
                    <Button className={`w-full py-3 ${plan.popular ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-900 hover:bg-gray-800 text-white'}`} data-testid={`button-signup-${plan.name.toLowerCase()}`}>
                      Start Free Trial
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-xl">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white/80 mb-10 max-w-3xl mx-auto leading-relaxed">
            In short: Autobidder helps you capture more leads, respond faster, and close more jobs—automatically.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/onboarding">
              <Button size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-10 py-5 text-lg rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl transform hover:scale-105 transition-all duration-300" data-testid="button-cta-start-trial">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-white/60 text-sm">
                The all-in-one platform for service businesses to generate more leads and close more deals.
              </p>
            </div>
