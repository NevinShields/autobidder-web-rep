  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="p-3 sm:p-8">
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
              <div className="flex-1">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 flex items-center gap-3 mb-3">
                ...
                <p className="text-base lg:text-lg text-gray-600 max-w-2xl">
                  Create and manage professional websites with our integrated Duda platform. 
                  Build beautiful, responsive sites with drag-and-drop ease.
                </p>
              </div>
        ...
        {/* Tabs - Desktop Optimized */}
        <Tabs defaultValue="websites" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:inline-flex h-auto p-1 bg-white border shadow-sm">
            <TabsTrigger value="websites" className="flex items-center gap-2 text-sm lg:text-base px-4 lg:px-6 py-3 data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
              <Layout className="h-4 w-4 lg:h-5 lg:w-5" />
              My Websites
            </TabsTrigger>
            <TabsTrigger value="templates" className="flex items-center gap-2 text-sm lg:text-base px-4 lg:px-6 py-3 data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
              <Image className="h-4 w-4 lg:h-5 lg:w-5" />
              Templates
            </TabsTrigger>
            <TabsTrigger value="settings" className="flex items-center gap-2 text-sm lg:text-base px-4 lg:px-6 py-3 data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
                ...
                {websites.map((website, index) => (
                  <Card key={website.site_name} className={`shadow-lg border-0 bg-white hover:shadow-xl transition-all duration-200 ${index === 0 ? 'lg:col-span-2 xl:col-span-2' : ''}`}>
                    ...
                    <CardContent className="p-6">
                      ...
                      {/* Website Stats - Desktop Optimized */}
